  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <View className="flex-1 items-center justify-center bg-black/45 px-6">
        <View className="w-full max-w-md rounded-[28px] border border-border/80 bg-white p-6 shadow-2xl">
          <Text className="text-xl font-bold text-text mb-2 tracking-tight">{title}</Text>
